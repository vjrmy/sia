...
class M_login extends CI_Model{
        ...
        function auth_mahasiswa($username,$password){
                $result=$this->db->query("SELECT * FROM tbl_mahasiswa INNER JOIN tbl_jurusan ON tbl_mahasiswa.jurusan=tbl_jurusan.id WHERE nim='$username' AND pass=sha1('$password') LIMIT 1"); 
                return $result;
        }
